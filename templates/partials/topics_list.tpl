	...
	<li component="category/topic" class="row clearfix category-item {function.generateTopicClass}" <!-- IMPORT partials/data/category.tpl -->>
		...
		<div class="content">
			...
			<h2 component="topic/header" class="title">
				...
				<!-- IF !topics.noAnchor -->
				<a class="c-topic-header" href="{config.relative_path}/topic/{topics.slug}<!-- IF topics.bookmark -->/{topics.bookmark}<!-- ENDIF topics.bookmark -->">{topics.title}</a>
				<!-- ELSE -->
				<div class="c-topic-header">{topics.title}</div>
		...
		<div class="hidden-sm hidden-xs stats stats-votes">
